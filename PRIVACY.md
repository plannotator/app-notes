...
App Notes is a local-first browser extension. It does not send personal data, browsing activity, notes, or analytics to Plannotator or Michael Ramos.

## Data App Notes stores

To restore and export annotations, App Notes stores the following in the browser's local extension storage:
